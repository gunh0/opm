      ...
      <main className={styles.container}>
        ...
        <div className={styles.textContainer}>
          ...
          <div className={styles.buttonContainer}>
            ...
            ?
            <>
              <div className={styles.editingButton} onClick={handleEditingButton}>Editing</div>
              <div className={styles.completionButton} onClick={handleCompletionButton}>Completion</div>
            </>
            :
            <>
              <div className={styles.blankButton}></div>
              <div className={styles.acceptButton} onClick={handleAcceptButton}>Accept</div>
            </>
            }
          </div>
        </div>
