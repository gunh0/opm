    ...
    <>
      ...
      <div className={styles.container}>
        ...
        <div>
          ...
          <div className={styles.description}>Let's get you all set up so you can vertify your personal account.</div>
          <div className={styles.registerContainer}>
            <div className={styles.inputContainer}>
              <div className={styles.subTitle}>First name</div>
              <input type="text" name="firstName" value={firstName} onChange={onChangeFirstName} className={styles.sign} />
            </div>
            <div className={styles.inputContainer}>
              <div className={styles.subTitle}>Last name</div>
              <input type="text" name="lastName" value={lastName} onChange={onChangeLastName} className={styles.sign} />
            </div>
            <div className={styles.inputContainer}>
              <div className={styles.subtitleContainer}>
                <div className={styles.subTitle}>E-mail</div>
                <div className={styles.guideText}>this address will be your ID</div>
              </div>
            ...
            <div className={styles.inputContainer}>
              <div className={styles.subtitleContainer}>
                ...
                <div className={styles.guideText}>should be longer than 8 words</div>
              </div>
          ...
          <div className={styles.signupContainer}>
            <label className={styles.agree}>
              <input type="checkbox" name="agree" value="yes" className={styles.checkbox} />
